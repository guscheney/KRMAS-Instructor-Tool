...
(async () => {
  ...
  // ── G. version ──
  ck('sw.js bumped to 135', /const VERSION = '135'/.test(fs.readFileSync('sw.js', 'utf8')));
  ck('index.html cache busters at 135', (fs.readFileSync('index.html', 'utf8').match(/\?v=135/g) || []).length >= 4);
