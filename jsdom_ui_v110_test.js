...
(async () => {
  ...
  // ── G. version ──
  ck('sw.js bumped to 136', /const VERSION = '136'/.test(fs.readFileSync('sw.js', 'utf8')));
  ck('index.html cache busters at 136', (fs.readFileSync('index.html', 'utf8').match(/\?v=136/g) || []).length >= 4);
