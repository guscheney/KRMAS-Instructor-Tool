...
(async () => {
  ...
  // ── G. version ──
  ck('sw.js bumped to 141', /const VERSION = '141'/.test(fs.readFileSync('sw.js', 'utf8')));
  ck('index.html cache busters at 141', (fs.readFileSync('index.html', 'utf8').match(/\?v=141/g) || []).length >= 4);
