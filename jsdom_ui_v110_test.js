...
(async () => {
  ...
  // ── G. version ──
  ck('sw.js bumped to 110', /const VERSION = '110'/.test(fs.readFileSync('sw.js', 'utf8')));
  ck('index.html cache busters at 110', (fs.readFileSync('index.html', 'utf8').match(/\?v=110/g) || []).length >= 4);
