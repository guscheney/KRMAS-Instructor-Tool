...
(async () => {
  ...
  // ── G. version ──
  ck('sw.js bumped to 133', /const VERSION = '133'/.test(fs.readFileSync('sw.js', 'utf8')));
  ck('index.html cache busters at 133', (fs.readFileSync('index.html', 'utf8').match(/\?v=133/g) || []).length >= 4);
