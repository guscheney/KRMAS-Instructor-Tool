...
(async () => {
  ...
  // ── G. version ──
  ck('sw.js bumped to 129', /const VERSION = '129'/.test(fs.readFileSync('sw.js', 'utf8')));
  ck('index.html cache busters at 129', (fs.readFileSync('index.html', 'utf8').match(/\?v=129/g) || []).length >= 4);
