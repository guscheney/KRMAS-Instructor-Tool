...
(async () => {
  ...
  // ── G. version ──
  ck('sw.js bumped to 142', /const VERSION = '142'/.test(fs.readFileSync('sw.js', 'utf8')));
  ck('index.html cache busters at 142', (fs.readFileSync('index.html', 'utf8').match(/\?v=142/g) || []).length >= 4);
