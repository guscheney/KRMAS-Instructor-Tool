...
// 2. Secrets (use the SAME VAPID pair that produced the public key in
//    index.html -- the private key is the one already in your previous
//    push-function header; keep it secret, never commit it):
